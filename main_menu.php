...
<head>
    ...
    <title>Nuhito Books | Main Menu</title>
    ...
    <div class="d-flex vh-100 flex-column flex-md-row">
        ...
        <div class="col d-flex flex-column justify-content-center align-items-center">
          <form class="d-flex flex-column align-items-center w-75 py-3" method="POST" action="">
            <figure> 
              <img src="assets/Asset 8.png" alt="smile logo" width="120">
            </figure>
            ...
            <div class="w-100 mt-2">
              ...
              <a href="masuk.php" class="btn btn-dark w-100 mt-3">Download Buku</a>

              <a href="masuk_admin.php" class="btn btn-dark w-100 mt-3">Tambah Buku</a>
