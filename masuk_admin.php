...
<head>
    ...
    <title>Nuhito Books | Masuk Admin </title>
    ...
    <div class="d-flex vh-100 flex-column flex-md-row">
        ...
        <div class="col d-flex flex-column justify-content-center align-items-center">
          <form class="d-flex flex-column align-items-center w-75 py-3" method="POST" action="">
            <figure> 
              <img src="assets/Asset 3.png" alt="admin-logo" width="120">
            </figure>
            ...
            <div class="w-100 mt-3">
              <div class="mb-3">
                <input type="text" class="form-control" id="adminEmail1" name="adminUsername" placeholder="Username" required> 
              </div>
              <div class="mb-3">
                <input type="password" class="form-control" id="adminPassword1" name="adminPassword" placeholder="Password" required>
              </div>

              <button type="submit" class="btn btn-dark w-100 mt-3">Masuk</button>
